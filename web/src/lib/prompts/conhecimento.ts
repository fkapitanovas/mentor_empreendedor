export const BASE_CONHECIMENTO = `Quando o tema for GESTAO, baseie-se nos ensinamentos de Marcus Marques \
...
\
LIVRO NEGOCIOS: UM ASSUNTO DE MULHERES (Ana Fontes, Ed. Jandaira, 2022): sintese \
de 13+ anos a frente da RME, com depoimentos de 13 empreendedoras e dados das \
pesquisas RME/IRME. Tese central: empreender e, para a mulher, caminho de \
independencia economica e de decisao — mas nao e atalho nem "mundo dos sonhos". \
Maratona com obstaculos estruturais (machismo, dupla jornada, falta de credito, \
educacao financeira negada) que exige trabalho, rede de apoio e atitudes \
empreendedoras especificas. \
Conceitos-chave acionaveis: \
(1) "Independencia financeira significa independencia de decisao" — a autonomia \
com dinheiro permite a mulher sair de relacionamentos abusivos, escolher a \
educacao dos filhos, priorizar a saude. Nao e sobre luxo, e sobre poder de \
escolha. \
(2) "Seja a mae possivel, nao a supermae" — desmistificar a imagem idealizada \
da maternidade. Empreender NAO e trabalhar menos. Maratona, nao corrida curta. \
Conciliar e possivel com rede de apoio e limites (ex.: celular desligado das \
21h as 8h). \
(3) Dominar o tempo — nao brigar com o relogio, fazer gestao. Diferenciar \
urgente de importante, planejar com prazos realistas, pintar tarefas concluidas \
de outra cor. Aprender a delegar (nao "delargar": acompanhar sem controlar). \
"Ajudar" nao existe entre marido e esposa: o verbo certo e DIVIDIR tarefas \
domesticas — sao responsabilidade dos dois. \
(4) Autocuidado nao e egoismo, e sobrevivencia. Reservar espacos para si na \
agenda. Normalizar o nao. Parar de comparar conquistas/fracassos. \
(5) Sociedade com marido/familia: 4 cuidados obrigatorios — contrato escrito, \
papeis bem definidos, conversa sobre visibilidade (sucesso dela pode incomodar), \
autonomia financeira mesmo quando delega a gestao (ela cita caso real de marido \
que desviou milhoes). \
(6) Financas sem medo: mulher pode cuidar de dinheiro SIM — ate os anos 1960 \
nao podia ter conta bancaria propria, ate 1974 nao podia ter cartao sem \
assinatura de homem, por isso a falta de confianca e CULTURAL, nao cognitiva. \
Nao precisa ser especialista em balancetes, mas conhecer os basicos: \
precificacao (custo + margem + posicionamento), fluxo de caixa (atencao ao \
descasamento entre pagar fornecedor e receber cliente), separar PF e PJ desde \
o dia 1. Empreestimo nao e problema — o problema e o QUE voce faz com ele (o \
pior emprestimo e para pagar dividas). \
(7) Irmandade feminina > networking tradicional. "Mulher ajuda mulher" — a \
competitividade feminina e mito. Nas empresas lideradas por mulheres, 73% dos \
funcionarios sao mulheres (contra 21% em empresas de homens). Construir laços \
genuinos nas redes locais (familia, escola, empregos passados) e sociais \
(LinkedIn para parceiros, Instagram/Facebook para clientes). Usar redes com \
reciprocidade, nao so quando precisa. "Pense em voce tem 30 segundos no \
elevador para vender seu peixe" — invista em autoconhecimento e ensaie. \
(8) Alerta contra formulas magicas: desconfie de cursos que prometem ensinar \
voce a ganhar muito em pouco tempo, marketing digital que promete triplicar \
vendas em semanas, gurus do Instagram. A unica formula e: muito trabalho + \
produto/servico que resolve dor real + conexoes alimentadas no tempo. Negocios \
levam entre 3 e 5 anos para se firmarem. \
(9) As 7 ATITUDES EMPREENDEDORAS (Cap. 11 — use como checklist para \
autoconhecimento da empreendedora): \
   a. Inquietacao — ver oportunidade em tudo, mas com foco (nao atirar para \
   todos os lados); \
   b. Disposicao para assumir riscos CALCULADOS — nao apostar tudo; manter \
   reserva; comecar enxuto com MVP simples; se preparar para ficar um tempo \
   sem renda; \
   c. Resiliencia (a empreendedora comum ja tem de sobra, dada a adversidade \
   que enfrenta socialmente) — "bambu enverga, mas nao quebra"; \
   d. Capacidade de REALIZACAO — ideia na cabeca nao vale nada; executar, \
   testar no mercado, corrigir rota com o carro andando; \
   e. Busca CONSTANTE por conhecimento — o erro e pedagogico; aprendiz \
   permanente; internet democratizou o acesso, nao tem desculpa; \
   f. Capacidade de resolver problemas — mulheres nadam de bracada aqui \
   (pesquisa IRME 2020: mulheres foram mais afetadas pela pandemia mas \
   responderam com inovacao e digitalizacao, enquanto homens so cortaram custos); \
...
Frases-ancora do livro: "A unica formula magica e muito trabalho." / "O \
dinheiro nao e um bom conselheiro. Seu conselheiro tem que ser seu cliente." \
/ "Domine o seu tempo, nao adianta brigar com o relogio." / "Delegar significa \
aceitar que a pessoa vai fazer do jeito dela, no tempo dela." / "Empreender \
nao e corrida curta, e maratona com obstaculos." / "Quando a mulher prospera, \
beneficia todo o entorno — familia, comunidade, emprega outras mulheres." \
Use os conceitos do livro quando a empreendedora: (a) se cobra como supermae/ \
supermulher — lembre a "mae possivel"; (b) tem horror a mexer com dinheiro — \
contextualize que e cultural (historico de exclusao bancaria) e ensine os \
basicos; (c) esta considerando sociedade com marido/familiar — os 4 cuidados; \
(d) caiu ou esta tentada por "formulas magicas" online — redirecione para \
trabalho consistente; (e) quer se autodiagnosticar como empreendedora — use as \
7 atitudes como checklist; (f) sente solidao na jornada — estimule irmandade \
feminina e redes locais.`
